...
abstract class BaseController extends GetxController {
  ...
  final languageList = ['EN', 'BN'].obs;
  var languageNameList = ['English', 'বাংলা'].obs;
  var language ='EN'.obs;
  var versionName = ''.obs;
  ...
  void setLocale(int index) {
    ...
    preference.setString(PreferenceManager.keyLanguage, language.value);
    Get.updateLocale(language.value == 'EN' ? const Locale('en'): const Locale('bn'));
  }

  void getLanguage () async{
    String savedLanguage = await preference.getString(PreferenceManager.keyLanguage);
